...
<p align="center">
  ...
  <img alt="GitHub Workflow Status" src="https://img.shields.io/github/workflow/status/girardinsamuel/masonite-socialite/Test%20Application">
  <img src="https://codecov.io/gh/girardinsamuel/masonite-socialite/branch/main/graph/badge.svg?token=H2JOM785OQ"/>
  <!-- <img alt="PyPI" src="https://img.shields.io/pypi/v/masonite-socialite"> -->
  <img src="https://img.shields.io/badge/python-3.6+-blue.svg" alt="Python Version">
  <img alt="GitHub release (latest by date including pre-releases)" src="https://img.shields.io/github/v/release/girardinsamuel/masonite-socialite?include_prereleases">
  <img alt="License" src="https://img.shields.io/github/license/girardinsamuel/masonite-socialite">
...
Add SocialiteProvider to your project in `config/providers.py`:

```python
# config/providers.py
# ...
from masonite.socialite import SocialiteProvider
